...
public class GetSalesHandler implements IGetSalesHandler {
    ...
    @Override
    public PagedResponse<ResponseSalesDto> getAll(PaginationRequest paginationRequest) {
    ...
    @Override
    public PagedResponse<ResponseSalesDto> getAllByEmployeeId(UUID employeeId, PaginationRequest paginationRequest) {
        return this.iMapperPaginationApp.pageResponseToPageResponseTypeResponse(
    ...
    @Override
    public PagedResponse<ResponseSalesDto> getAllByDateSale(LocalDateTime dateSale, PaginationRequest paginationRequest) {
        return this.iMapperPaginationApp.pageResponseToPageResponseTypeResponse(
    ...
    @Override
    public PagedResponse<ResponseSalesDto> getAllByMethodPayment(String methodPayment, PaginationRequest paginationRequest) {
        return this.iMapperPaginationApp.pageResponseToPageResponseTypeResponse(
    ...
    @Override
    public PagedResponse<ResponseSalesDto> getAllByStatus(String status, PaginationRequest paginationRequest) {
        return this.iMapperPaginationApp.pageResponseToPageResponseTypeResponse(
    ...
    @Override
    public PagedResponse<ResponseSalesDto> getAllByDiscount(BigDecimal discount, PaginationRequest paginationRequest) {
        return this.iMapperPaginationApp.pageResponseToPageResponseTypeResponse(
    ...
    @Override
    public ResponseSalesDto getById(UUID id) {
        return this.iMapperSalesApplication.toResponse(this.iGetSalesServices.getById(id));
    }

    @Override
    public ResponseSalesDto getByNumberSale(UUID numberSale) {
