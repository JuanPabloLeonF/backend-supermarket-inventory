...
public class GetAllPurchaseQueryHandler implements IRequestHandler<GetAllPurchaseQuery, PagedResponse<ResponsePurchaseDto>> {
    ...
    @Override
    public PagedResponse<ResponsePurchaseDto> handle(GetAllPurchaseQuery request) {
        PaginationRequest data = PaginationRequest.builder()
                .page(request.page())
                .size(request.size())
                .build();
        PagedResponse<PurchaseModel> pagedResponse = this.iGetPurchaseService.getAll(data);
    ...
    @Override
    public Class<GetAllPurchaseQuery> getRequestType() {
        return GetAllPurchaseQuery.class;
    }
}
