package dev.juanleon.supermarket_inventory.modules.products.infrastructure.inputs.controllers;

import dev.juanleon.supermarket_inventory.share.mediator.Mediator;
import dev.juanleon.supermarket_inventory.share.utils.dto.PagedResponse;
import dev.juanleon.supermarket_inventory.share.utils.dto.ResponseRequestDto;
import dev.juanleon.supermarket_inventory.modules.products.application.commands.delete.DeleteByIdProductCommand;
import dev.juanleon.supermarket_inventory.modules.products.application.commands.post.CreateProductCommand;
import dev.juanleon.supermarket_inventory.modules.products.application.commands.update.UpdateActivateProductCommand;
import dev.juanleon.supermarket_inventory.modules.products.application.commands.update.UpdateProductCommand;
import dev.juanleon.supermarket_inventory.modules.products.application.commands.update.UpdateUrlImgProductCommand;
import dev.juanleon.supermarket_inventory.modules.products.application.dto.*;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllByActiveProductsQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllByCategoriesProductsQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllByCreatedAtProductQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllByNameProductsQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllByPricePurchaseProductsQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllByPriceSaleProductsQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllByStockProductsQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllByUnitMeasurementProductsQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllByUpdatedAtProductQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getAll.GetAllProductsQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getBy.GetByCodeProductsQuery;
import dev.juanleon.supermarket_inventory.modules.products.application.queries.getBy.GetByIdProductsQuery;
