package dev.juanleon.supermarket_inventory.modules.cash_register.infrastructure.outputs.database.adapters.post;
...
import dev.juanleon.supermarket_inventory.modules.cash_register.infrastructure.outputs.database.entities.CashRegisterEntity;
import dev.juanleon.supermarket_inventory.modules.cash_register.infrastructure.outputs.database.mappers.IMapperCashRegisterInfrastructure;
import dev.juanleon.supermarket_inventory.modules.cash_register.infrastructure.outputs.database.repositories.ICashRegisterRepository;
import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Repository;

import java.util.UUID;

import static dev.juanleon.supermarket_inventory.share.utils.enums.MessagesApp.CASH_REGISTER_CREATED_SUCCESSFULLY;
