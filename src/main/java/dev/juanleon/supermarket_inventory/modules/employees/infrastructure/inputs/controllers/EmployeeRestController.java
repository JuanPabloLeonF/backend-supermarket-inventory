...
import dev.juanleon.supermarket_inventory.modules.employees.application.commands.delete.DeleteByIdEmployeeAndUserCommand;
import dev.juanleon.supermarket_inventory.modules.employees.application.commands.post.RegisterEmployeeAndUserCommand;
import dev.juanleon.supermarket_inventory.modules.employees.application.commands.update.UpdateByIdEmployeeAndUserCommand;
import dev.juanleon.supermarket_inventory.modules.employees.application.commands.update.UpdateByIdImgCommand;
...
public class EmployeeRestController {
    ...
    public ResponseEntity<ResponseRequestDto> deleteByIdEmployeeAndUser(@PathVariable("idEmployee") UUID idEmployee) {
        DeleteByIdEmployeeAndUserCommand command = new DeleteByIdEmployeeAndUserCommand(idEmployee);
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(this.mediator.dispatch(command));
    }
