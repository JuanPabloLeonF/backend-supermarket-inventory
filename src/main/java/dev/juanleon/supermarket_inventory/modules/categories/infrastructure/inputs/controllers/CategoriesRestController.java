package dev.juanleon.supermarket_inventory.modules.categories.infrastructure.inputs.controllers;

import dev.juanleon.supermarket_inventory.modules.categories.application.commands.delete.DeleteByIdCategoriesCommand;
import dev.juanleon.supermarket_inventory.modules.categories.application.commands.post.CreateCategoriesCommand;
import dev.juanleon.supermarket_inventory.modules.categories.application.commands.update.UpdateByIdCategoriesCommand;
...
import dev.juanleon.supermarket_inventory.modules.categories.application.queries.getAll.GetAllByNameCategoriesQuery;
import dev.juanleon.supermarket_inventory.modules.categories.application.queries.getAll.GetAllCategoriesQuery;
import dev.juanleon.supermarket_inventory.modules.categories.application.queries.getBy.GetByIdCategoriesQuery;
