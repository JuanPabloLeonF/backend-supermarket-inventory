package dev.juanleon.supermarket_inventory.modules.sales.infrastructure.outputs.database.repositories;
...
public interface ISalesRepository extends JpaRepository<SalesEntity, UUID> {
    ...
    @EntityGraph(attributePaths = {
            "employee",
            "employee.userEntity",
            "salesDetailsEntityList",
            "salesDetailsEntityList.productEntity",
            "salesDetailsEntityList.productEntity.categoriesEntity"
    }
    )
