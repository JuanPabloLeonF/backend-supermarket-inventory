package dev.juanleon.supermarket_inventory.categories.infrastructure.outputs.configuration;
...
import dev.juanleon.supermarket_inventory.categories.domain.useCases.delete.DeleteCategoriesUseCases;
import dev.juanleon.supermarket_inventory.categories.domain.useCases.get.GetCategoriesUseCases;
import dev.juanleon.supermarket_inventory.categories.domain.useCases.post.PostCategoriesUseCases;
import dev.juanleon.supermarket_inventory.categories.domain.useCases.update.UpdateCategoriesUseCases;
