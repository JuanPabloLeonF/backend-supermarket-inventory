...
public interface IGetProductsHandler {
    ...
    PagedResponse<ResponseProductDto> getByPriceSale(PaginationRequest paginationRequest, Double priceSale);
    PagedResponse<ResponseProductDto> getByPricePurchase(PaginationRequest paginationRequest, Double pricePurchase);
