package dev.juanleon.supermarket_inventory.share.utils.enums;
...
public enum MessagesApp {
    ...
    USER_NOT_FOUND_BY_DATA("User not found with data: %s"),
    ...
    PRODUCT_NOT_FOUND_BY_DATA("Product not found with data: %s"),
